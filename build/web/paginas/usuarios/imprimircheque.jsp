...
<%
    ...
    String fechaSTR = "";
    Cheque cheque = (Cheque) request.getAttribute("cheque_imprimir");
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" action="<%=request.getContextPath()%>/cheques?accion=imprimir_cheque&id_rol=<%out.println(id_rol);%>&id_cheque=<%out.println(cheque.getId());%>&username=<%out.println(this.username);%>&monto=<%out.println(cheque.getMonto());%>" method="POST" class="was-validate">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-block waves-effect">Imprimir</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
